...
<main>
    <aside>
        <h3>주요기능</h3>
        <ul>
            <li class="on"><a href="${ctxPath}/admin/productList.jsp">상품관리</a></li>
            <li><a href="${ctxPath}/admin/index.jsp">주문관리</a></li>
            <li><a href="${ctxPath}/admin/userList.jsp">회원관리</a></li>                    
        </ul>
    </aside>
    <section id="productRegister">
        ...
        <article>
            <form action="${ctxPath}/admin/productRegister.do" method="post" enctype="multipart/form-data">
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="type">
                                <option>구분</option>
                                <option value="1">과실류</option>
                                <option value="2">채소류</option>
                                <option value="3">양곡</option>
                                <option value="4">축산</option>
                                <option value="5">수산</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                ...
                <p>
                    <a href="${ctxPath}/admin/productList.jsp" class="btnCancel">취소</a>
